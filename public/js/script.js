...
const client_id = "ASy2lguYpFDqp0h46iTuN07jqUQP60XMyx0LN22wa7jLO2KYpbBenO8jlhM1QzKCCgC1e4of-cYTuJj1";
const currency = "USD";
...
url_to_head(paypal_sdk_url + "?client-id=" + client_id + "&disable-funding=credit,card&enable-funding=paypal&currency=" + currency + "&intent=" + intent)
.then(() => {
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        onApprove: function(data, actions) {
            ...
            .then((order_details) => {
                ...
                showToast('Success',`Thank you ${order_details.payer.name.given_name} ${order_details.payer.name.surname} for your payment of ${order_details.purchase_units[0].payments[intent_object][0].amount.value} ${order_details.purchase_units[0].payments[intent_object][0].amount.currency_code}`)
             ...
             .catch((error) => {
                ...
                showToast('Error','An Error Ocurred!');
             });
        },
